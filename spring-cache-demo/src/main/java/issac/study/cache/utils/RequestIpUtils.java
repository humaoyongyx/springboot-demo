...
public class RequestIpUtils {
    ...
    public static String getIpAddress(HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(ipAddresses) || UNKNOWN_CONTENT.equalsIgnoreCase(ipAddresses)) {
        ...
        if (StringUtils.length(ipAddresses) > 0) {
    ...
    public static String getHost(HttpServletRequest request) {
        ...
        if (org.springframework.util.StringUtils.hasLength(host)) {
            return host;
        } else {
